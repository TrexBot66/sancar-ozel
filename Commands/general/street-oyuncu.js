...
module.exports = {
    ...
    run(message, args, client) {
        ...
        member.roles.add(Config.Roles.streetoyuncu).catch(e => { });

        message.channel.send({ embeds: [new Discord.MessageEmbed().setFooter(message.guild.name).setDescription(`**Kullanıcıya başarılı bir şekilde <@&${Config.Roles.streetoyuncu}> permi verildi.**`)] })
    }}